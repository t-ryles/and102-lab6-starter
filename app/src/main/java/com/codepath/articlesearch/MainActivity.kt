...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNavigationView.setOnItemSelectedListener { item ->
            ...
            when (item.itemId) {
                R.id.bestsellingIcon -> fragment = bestSellerBooksFragment
                R.id.articlesIcon -> fragment = articleListFragment
            }
        ...
        bottomNavigationView.selectedItemId = R.id.articlesIcon
    }
